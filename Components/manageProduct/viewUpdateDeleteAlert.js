...
export default class viewUpdateDeleteAlert extends Component {
    _showAlert(){
        ...
        [
            ...
            {   
                text: 'Xác nhận', onPress: () => console.log('Xác nhận') 
            }
        ],
    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                ...
                <TouchableOpacity style={{backgroundColor:'#b2bec3',  marginTop:10, marginBottom:-60, flex:1}}>   
                        <Image source={require('../../assets/download.jpeg')} style={{marginLeft:1, height:175, width: 410}}/>
                </TouchableOpacity>

                <View elevation={5} style={styles.it1}>
                    <Text style={{color:'black', fontWeight:'bold'}}>Cơm tấm</Text>
                </View>
                 </View>
                 ...
                 <View style={{flex:7, backgroundColor:'white'}}>
                    ...
                    <TouchableOpacity style={{backgroundColor:'#81ecec', marginRight: 247, marginLeft:60, marginTop:210,width:80, borderRadius:10, padding:5}}>
                       <Text style={{color:'black', fontFamily:"Copperplate", paddingLeft:7}}>Cập nhật</Text>
                    </TouchableOpacity>
                   
                   <TouchableOpacity onPress={this._showAlert} style={{backgroundColor:'#ff7675', marginLeft:265, marginRight:30, marginTop:-30, width:80, borderRadius:10, padding:5}}>
